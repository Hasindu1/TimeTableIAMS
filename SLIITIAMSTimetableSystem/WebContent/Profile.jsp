...
<div  >
<div class="card h-100" class="cardcenter">
	<div class="card-body">
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="phone" placeholder="Enter Emp Id">
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="phone">Name With Initials</label>
					<input type="text" class="form-control" id="phone" placeholder="Enter Name With Initials">
				</div>
			</div>
				<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="phone">Full Name</label>
					<input type="text" class="form-control" id="phone" placeholder="Enter Name Full Name">
				</div>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="phone">Contact No 1</label>
					<input type="text" class="form-control" id="phone" placeholder="Enter Contact No 1">
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="website">Contact No 2</label>
					<input type="url" class="form-control" id="website" placeholder="Enter Contact No 2">
				</div>
			</div>
		</div>
				<div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<h6 class="mt-3 mb-2 text-primary">User Account Details</h6>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="Street">Password</label>
					<input type="name" class="form-control" id="Street" placeholder="Enter Research Groups">
				</div>
			</div>
		...
		<div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="text-right">
					...
					<a href="https://www.sliit.lk/about/about-sliit/academic-staff/" class="btn btn-secondary">View</a>
					<button type="button" id="submit" name="submit" class="btn btn-danger">Cancel</button>
