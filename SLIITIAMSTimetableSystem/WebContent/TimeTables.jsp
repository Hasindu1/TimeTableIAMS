		...
		<div id="Monday" class="tabcontent">
			...
			<div class="form-row">
				...
				<div class="col">
					...
					<select class="form-control" placeholder="Start Time">
 				 <option>8.00 AM</option>
 				  ...
 				  <option>9.00 AM</option>
					...
					<select class="form-control" placeholder="End Time">
 				 <option>8.00 AM</option>
 				  <option>8.30 AM</option>
 				  <option>9.00 AM</option>
 				   <option>9.30 AM</option>
			...
			<br>
			<button type="submit" class="btn btn-success" onclick="getRow(1);">Save</button>
...
// 	data.style.column-span = 4;
	...
	function closeForm() {
		document.getElementById("timetableForm").style.display = "TimeTables.jsp";
	}
</script>
