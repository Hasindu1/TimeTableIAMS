 ...
 <div>
 	...
 	<nav class="navbar navbar-header navbar-expand-lg" data-background-color="light-blue2">
              ...
              <div class="main-header" class="navbar navbar-header navbar-expand-lg" data-background-color="light-blue2" >
                    <h2><b> Academic Groups Details</b><button type="button" class="btn btn-success add-new"><i class="fa fa-plus"></i> Add New</button></h2>
 ...
 <div class="container" >
       <div  class="table-wrapper" >
            ...
            <table class="table table-bordered" >
                ...
                <option value="6">ISE</option>
                 <option value="7">CSNE</option>
                         ...
                         <td class = "select" >
                          ...
                          <select>        
                <option value="1">Y1.S1</option>
                <option value="2">Y1.S2</option>
                <option value="3">Y2.S1</option>
                <option value="4">Y2.S2</option>
                <option value="5">Y3.S1</option>
                <option value="6">Y3.S2</option>
                 <option value="7">Y4.S1</option>
                  <option value="8">Y4.S2</option>
                      ...
                      <td></td>
                        ...
                        <td>
                         	<a class="add" title="Add" data-toggle="tooltip"><i class="material-icons"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></i></a>
                            <a class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons"><i class="fa fa-pencil" aria-hidden="true"></i></i></a>
                            <a class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons"><i class="fa fa-trash-o" aria-hidden="true"></i></i></a>
...
<script src="./assets/js/groups_table.js"></script>
