$(document).ready(function(){
    ...
    $(".add-new").click(function(){
        ...
        var row = '<tr>' +
            ...
            '<td><select class="form-control" name="6" id="6"><option>IT</option><option>SE</option><option>DS</option><option>ISE</option><option>CSNE</option><option>CS</option><option>IM</option></td>' +
            '<td><select class="form-control" name="7" id="7"><option>WD</option><option>WE</option><option>All</option></td>' +
