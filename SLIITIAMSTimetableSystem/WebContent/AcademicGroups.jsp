<!DOCTYPE html>
<%@page import="iams.modal.Batch"%>
<%@page import="java.util.ArrayList"%>
<%@page import="iams.dao.BatchDao"%>
<html>
<head>
...
<body>
	...
	<div class="wrapper">
		...
		<div class="form-popup" id="myForm">
			<form class="form-container" name="signupform" action="BatchServelet"
				method="post">
				<h1>Add Batches</h1>

				<label for="batchid"><b>Batch Id</b></label> <input type="text"
					placeholder="Enter Batch Id" name="batchid" required> 
			...
			<div class="table-wrapper">
				...
				<table id="table" data-toggle="table" data-search="true"
					...
					<thead>
						<tr>
							...
							<th data-field="batchid" data-filter-control="input"
								data-sortable="true">Batch ID</th>
					...
					<tr>
						...
						<form method="POST" action="EditBatch">
						<td><button class="btn btn-info" type="submit" name="btn_edit" value=<%=h.getBatchId()%>>Edit</button></td>
						</form>
						
						<form method="POST" action="DeleteBatchServelet">
							<td><button type="submit" class="btn btn-danger"
									name="btn_delete" value=<%=h.getBatchId()%>>Delete</button></td>
						</form>
	...
	<script>
		...
		function saveForm() {
			...
			window.location.href = 'AcademicGroups.jsp';
		}
	</script>
</body>
